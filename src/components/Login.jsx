...
import { loginConGoogle, loginConFacebook, enviarEnlaceAcceso, esEnlaceDeAcceso, completarLoginConEnlace } from '../services/auth.js';
          ...
          {enlaceEnviado ? (
            ...
            <>
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 bg-[#1877F2] text-white font-semibold py-3 px-4 rounded-lg hover:bg-[#166FE5] transition mb-4 disabled:opacity-50"
              >
